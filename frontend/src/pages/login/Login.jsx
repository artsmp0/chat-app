      ...
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-200 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form>
          <div>
            ...
            <input type="text" placeholder="Enter username" className="w-full input input-bordered input-warning h-10" />
          </div>
          ...
          <div>
            <button className="btn btn-block btn-warning btn-sm mt-2">Login</button>
          </div>
        </form>
      </div>
    </div>
